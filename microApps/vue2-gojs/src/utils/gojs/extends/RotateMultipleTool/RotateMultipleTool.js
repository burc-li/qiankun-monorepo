'use strict'
import go from 'gojs'
import { updateAroundGroup } from '@/common/gojs/utils/group'
import { getPartsBounds } from '@/common/gojs/utils/bounds'
export default function RotateMultipleTool () {
  go.RotatingTool.call(this)
  this.name = 'RotateMultiple'
  this.handleAngle = 225 // 右下：45 左下：135 左上：225 右上：315
