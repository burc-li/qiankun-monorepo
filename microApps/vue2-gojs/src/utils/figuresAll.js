...
go.Shape.defineFigureGenerator('LogicImplies', function(shape, w, h) {
  ...
  return new go.Geometry()
    .add(
      new go.PathFigure((1 - param1) * w, 0, false)
        .add(new go.PathSegment(go.PathSegment.Line, w, 0.5 * h))
...
go.Shape.defineFigureGenerator('DoubleEndArrow', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.3 * w, y2))
...
go.Shape.defineFigureGenerator('DoubleEndArrow2', function(shape, w, h) {
  ...
  */
  ...
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.7 * w, y2))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.3 * w, y2))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.3 * w, y2outer))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0, 0.5 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.3 * w, y1outer))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.3 * w, y1))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.7 * w, y1))
...
go.Shape.defineFigureGenerator('IBeamArrow2', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.7 * w, y2))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.2 * w, y2))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.2 * w, y2outer))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0, y2outer))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0, y1outer))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.2 * w, y1outer))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.2 * w, y1))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.7 * w, y1))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.7 * w, y1outer).close())
  geo.spot1 = new go.Spot(0, y1 / h)
...
go.Shape.defineFigureGenerator('Cylinder1', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Bezier, 1.0 * w, param1, (0.5 + cpxOffset) * w, 0, 1.0 * w, KAPPA * param1))
...
go.Shape.defineFigureGenerator('Cylinder2', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Line, 0, param1))
  fig.add(new go.PathSegment(go.PathSegment.Bezier, 0.5 * w, 0, 0, KAPPA * param1, (0.5 - cpxOffset) * w, 0))
  fig.add(new go.PathSegment(go.PathSegment.Bezier, w, param1, (0.5 + cpxOffset) * w, 0, w, KAPPA * param1))
  fig.add(new go.PathSegment(go.PathSegment.Line, w, h - param1))
...
go.Shape.defineFigureGenerator('Database', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Line, w, 0.9 * h))
  fig.add(new go.PathSegment(go.PathSegment.Bezier, 0.5 * w, h, w, (0.9 + cpyOffset) * h, (0.5 + cpxOffset) * w, h))
  fig.add(new go.PathSegment(go.PathSegment.Bezier, 0, 0.9 * h, (0.5 - cpxOffset) * w, h, 0, (0.9 + cpyOffset) * h))
...
go.Shape.defineFigureGenerator('DividedEvent', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Bezier, w, 0.2 * h, (0.8 + cpOffset) * w, 0, w, (0.2 - cpOffset) * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w, 0.8 * h))
  fig.add(new go.PathSegment(go.PathSegment.Bezier, 0.8 * w, h, w, (0.8 + cpOffset) * h, (0.8 + cpOffset) * w, h))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.2 * w, h))
...
go.Shape.defineFigureGenerator('PaperTape', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Bezier, w, 0.3 * h, 0.5 * w, 0.6 * h, 0.5 * w, 0))
  fig.add(new go.PathSegment(go.PathSegment.Line, w, 0.7 * h))
  fig.add(new go.PathSegment(go.PathSegment.Bezier, 0, 0.7 * h, 0.5 * w, 0.4 * h, 0.5 * w, h).close())
...
go.Shape.defineFigureGenerator('AndGate', function(shape, w, h) {
  ...
  // The gate body
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.5 * w, 0))
  fig.add(new go.PathSegment(go.PathSegment.Bezier, w, 0.5 * h, (0.5 + cpOffset) * w, 0, w, (0.5 - cpOffset) * h))
  fig.add(new go.PathSegment(go.PathSegment.Bezier, 0.5 * w, h, w, (0.5 + cpOffset) * h, (0.5 + cpOffset) * w, h))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0, h).close())
  geo.spot1 = go.Spot.TopLeft
...
go.Shape.defineFigureGenerator('FireHazard', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Bezier, 0.51 * w, 0.42 * h, 0.48 * w, 0.17 * h, 0.54 * w, 0.35 * h))
  fig.add(new go.PathSegment(go.PathSegment.Bezier, 0.59 * w, 0.18 * h, 0.59 * w, 0.29 * h, 0.58 * w, 0.28 * h))
  fig.add(new go.PathSegment(go.PathSegment.Bezier, 0.75 * w, 0.6 * h, 0.8 * w, 0.34 * h, 0.88 * w, 0.43 * h))
  fig.add(new go.PathSegment(go.PathSegment.Bezier, 0.88 * w, 0.31 * h, 0.87 * w, 0.48 * h, 0.88 * w, 0.43 * h))
  fig.add(new go.PathSegment(go.PathSegment.Bezier, 0.9 * w, h, 1.17 * w, 0.76 * h, 0.82 * w, 0.8 * h).close())
...
go.Shape.defineFigureGenerator('BpmnTaskUser', function(shape, w, h) {
  ...
  fig2.add(new go.PathSegment(go.PathSegment.Bezier, w, 0.68 * h, (1 - 0.12) * w, 0.46 * h, (1 - 0.02) * w, 0.54 * h))
  fig2.add(new go.PathSegment(go.PathSegment.Line, w, h))
  fig2.add(new go.PathSegment(go.PathSegment.Line, 0, h))
...
go.Shape.defineFigureGenerator('BpmnEventError', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.66 * w, 0.5 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w, 0))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.66 * w, h))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.33 * w, 0.5 * h).close())
  return geo
})
...
go.Shape.defineFigureGenerator('Recycle', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.3 * w, 0.625 * h))
...
go.Shape.defineFigureGenerator('Wave', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Line, 0, 0.75 * h))
  fig.add(new go.PathSegment(go.PathSegment.Bezier, 0.3 * w, 0.75 * h, 0.1 * w, 0.5 * h, 0.2 * w, 0.5 * h))
...
go.Shape.defineFigureGenerator('Building', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Line, 0, h * 0.3))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.046 * w, h * 0.3))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0.5 * w, h * 0))
  fig.add(new go.PathSegment(go.PathSegment.Line, (1 - 0.046) * w, h * 0.3))
  fig.add(new go.PathSegment(go.PathSegment.Line, w, h * 0.3))
...
go.Shape.defineFigureGenerator('Staircase', function(shape, w, h) {
  ...
  // Bottom part
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.2, h * 1)) // bottom left part
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.2, h * 0.8))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.4, h * 0.8))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.4, h * 0.6))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.6, h * 0.6))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.6, h * 0.4))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.8, h * 0.4))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.8, h * 0.2))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 1, h * 0.2))
...
go.Shape.defineFigureGenerator('Key', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.5, 0.35 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.45, 0.35 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.3, 0.2 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.15, 0.2 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0, 0.35 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, 0, 0.65 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.15, 0.8 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.3, 0.8 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.45, 0.65 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.5, 0.65 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.5, 0.6 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.6, 0.6 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.65, 0.55 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.7, 0.6 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.75, 0.55 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.8, 0.6 * h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.85, 0.575 * h))
...
go.Shape.defineFigureGenerator('SpeechBubble', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.7, bubbleH))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.7, h))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.55, bubbleH))
...
go.Shape.defineFigureGenerator('Repeat', function(shape, w, h) {
  ...
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.5, h * 0.45))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.3, h * 0.45))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.3, h * 0.9))
  fig.add(new go.PathSegment(go.PathSegment.Line, w * 0.6, h * 0.9))
  ...
  fig2.add(new go.PathSegment(go.PathSegment.Line, w * 0.7, h * 0.55))
  fig2.add(new go.PathSegment(go.PathSegment.Line, w * 0.7, h * 0.1))
  fig2.add(new go.PathSegment(go.PathSegment.Line, w * 0.4, h * 0.1))
  fig2.add(new go.PathSegment(go.PathSegment.Line, w * 0.35, h * 0))
  fig2.add(new go.PathSegment(go.PathSegment.Line, w * 0.8, h * 0))
  fig2.add(new go.PathSegment(go.PathSegment.Line, w * 0.8, h * 0.55).close())
  return geo
})
...
go.Shape.defineFigureGenerator('Terminal', function(shape, w, h) {
  ...
  fig2.add(new go.PathSegment(go.PathSegment.Line, w * 0.1, h * 0.32))
...
go.Shape.defineFigureGenerator('Download', function(shape, w, h) {
  ...
  fig2.add(new go.PathSegment(go.PathSegment.Line, w * 0.6, h * 0.44))
  fig2.add(new go.PathSegment(go.PathSegment.Line, w * 0.6, h * 0).close())
  return geo
})
...
go.Shape.defineFigureGenerator('Upload', function(shape, w, h) {
  ...
  fig2.add(new go.PathSegment(go.PathSegment.Line, w * 0.4, h * 0.63))
  fig2.add(new go.PathSegment(go.PathSegment.Line, w * 0.6, h * 0.63))
  fig2.add(new go.PathSegment(go.PathSegment.Line, w * 0.6, h * 0.25))
